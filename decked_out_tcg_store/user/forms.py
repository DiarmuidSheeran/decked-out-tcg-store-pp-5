...
class UpdateForm(ModelForm):
    ...
    shipping_address_town = forms.CharField(max_length=255, required=False)
    shipping_address_county = forms.CharField(max_length=20, required=False)
    shipping_address_eircode = forms.CharField(max_length=255, required=False)
